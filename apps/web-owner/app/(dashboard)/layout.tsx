...
const nav = [
  ...
  { label: 'Locations', href: '/sites', icon: '📍' },
  { label: 'Pricing', href: '/pricing', icon: '💰' },
  { label: 'Users', href: '/users', icon: '👥' },
  { label: 'DATEV Export', href: '/exports', icon: '📤' },
    ...
    <div className="flex min-h-screen">
      <aside className="w-60 border-r bg-white p-4 flex flex-col shadow-sm">
        <div className="mb-1 flex items-center gap-2 px-2 py-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">Owner view</p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col">
        <header className="border-b border-gray-200 bg-white px-6 py-3 flex items-center justify-between">
          ...
          <span className="text-xs text-gray-400">2 sites active</span>
        </header>
