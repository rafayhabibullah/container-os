        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          {payments.length === 0 ? (
            <div style={{ background: '#ffffff', borderRadius: '12px', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(15,23,42,0.06)', padding: '64px 24px', textAlign: 'center' }}>
              <p style={{ fontSize: '14px', fontWeight: 600, color: '#0f172a', margin: '0 0 4px' }}>No payments recorded yet</p>
              <p style={{ fontSize: '13px', color: '#94a3b8', margin: 0 }}>Payments will appear here once processed.</p>
            </div>
          ) : (
                  ...
                  {payments.map((p) => {
                    ...
                    return (
                      <tr key={p.id} className="tbl-row" style={{ borderBottom: '1px solid #f8fafc' }}>
                        ...
                        <td style={{ padding: '12px 16px', color: '#475569', textTransform: 'capitalize' }}>{p.method.replace('_', ' ')}</td>
